  ...
  fetchPricing() {
    return {
      products: [
        ...
        {
          sku: 'SW-PT-002',
          name: 'SuperPaint Interior Latex',
          unit: 'gallon',
          price: 62.0,
          category: 'Painting',
        },
      ...
      _stub: true,
      _note:
        'Replace with real Sherwin Williams API integration. See OAuth2 example in comments above.',
    };
  },
